...
latex_documents = [
    (master_doc, 'gryffin.tex', u'Gryffin Documentation',
...
man_pages = [
    (master_doc, 'gryffin', u'Gryffin Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'gryffin', u'Gryffin Documentation',
     author, 'gryffin', 'One line description of project.',
     'Miscellaneous'),
]
