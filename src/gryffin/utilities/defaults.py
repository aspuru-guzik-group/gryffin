...
# ======================================
# Default predictive model configuration
# ======================================
default_predictive_model_configurations = {
    'model_kind':            None, # kind of predictive model to use
    'transformation':       'identity', # kind of transformation opt <> pred
    'training_regime':      're-train',
    'train_after':          1,
    'cv_folds':             3,
}
...
default_configuration = {
    ...
    'predictive_model': {
        key : default_predictive_model_configurations[key] for key in default_predictive_model_configurations.keys()
    },
    'parameters': [
